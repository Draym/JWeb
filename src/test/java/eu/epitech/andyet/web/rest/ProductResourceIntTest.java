...
public class ProductResourceIntTest {
    ...
    private static final Integer DEFAULT_SILL = 0;
    private static final Integer UPDATED_SILL = 1;
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getValid()).isEqualTo(DEFAULT_VALID);
        assertThat(testProduct.getStock()).isEqualTo(DEFAULT_STOCK);
        assertThat(testProduct.getPrice()).isEqualTo(DEFAULT_PRICE);
        assertThat(testProduct.getSill()).isEqualTo(DEFAULT_SILL);
    }
    ...
    @Test
    @Transactional
    public void checkSillIsRequired() throws Exception {
        int databaseSizeBeforeTest = productRepository.findAll().size();
        // set the field null
        product.setSill(null);
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
                ...
                .andExpect(jsonPath("$.[*].sill").value(hasItem(DEFAULT_SILL)));
    }
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.sill").value(DEFAULT_SILL));
    }
    ...
    public void updateProduct() throws Exception {
        ...
        Product testProduct = products.get(products.size() - 1);
        assertThat(testProduct.getValid()).isEqualTo(UPDATED_VALID);
        assertThat(testProduct.getStock()).isEqualTo(UPDATED_STOCK);
        assertThat(testProduct.getPrice()).isEqualTo(UPDATED_PRICE);
        assertThat(testProduct.getSill()).isEqualTo(UPDATED_SILL);
    }
